...
def build_left_layout(self):
    ...
    self.step_buttons_frame.columnconfigure((0, 1, 2, 3, 4, 5), weight=1)
    ...
    self.btn_optimize_architecture = ctk.CTkButton(
        self.step_buttons_frame,
        text="Step2. 架构优化",
        command=self.optimize_novel_architecture_ui,
        font=("Microsoft YaHei", 12)
    )
    self.btn_optimize_architecture.grid(row=0, column=1, padx=5, pady=2, sticky="ew")
    ...
    self.btn_batch_generate.grid(row=0, column=5, padx=5, pady=2, sticky="ew")
